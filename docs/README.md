...
- **架構師** → `system-architecture.md` (45 分) + `project-overview-pdr.md` (15 分)
...
├── system-architecture.md       # 系統架構與設計
├── codebase-summary.md          # 代碼庫摘要 (快速查詢)
...
└──────────────────┬──────────────────────┘
         ...
         v         v         v
┌──────────────┐  │  ┌──────────────────┐
│system-arch.md│  │  │codebase-summ.md  │
│(架構設計)   │  │  │(代碼查詢)        │
└──────────────┘  │  └──────────────────┘
         │        │         │
         └────┬───┘         │

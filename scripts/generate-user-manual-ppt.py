...
txt(s, 0.8, 5.5, 11.4, 0.5, "💡 系統每日 16:30 自動更新  |  FinMind 額度耗盡自動切 TWSE 全量備援", sz=16, color=DIM, align=PP_ALIGN.CENTER)
...
bar(s, 4.5, 3.3, 4)
txt(s, 1, 3.6, 11, 0.8, "台股智慧選股系統 v3.5", sz=24, color=WHITE, align=PP_ALIGN.CENTER)
txt(s, 1, 4.8, 11, 0.5, "多因子篩選  ×  AI 智慧分析  ×  動能信號偵測", sz=18, color=DIM, align=PP_ALIGN.CENTER)

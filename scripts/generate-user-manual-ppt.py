...
txt(s, 7.1, 5.25, 5, 0.35, "• 非 Pipeline 股票自動補充歷史資料", sz=15, color=GRAY)
...
txt(s, 1.1, 4.6, 11.2, 0.5, "💡  三組篩選標籤（條件 / 風險 / 操作）可組合疊加，逐步縮小篩選範圍", sz=20, color=GOLD, bold=True, align=PP_ALIGN.CENTER)
txt(s, 1.1, 5.2, 11.2, 0.4, "篩選結果表格含 9 欄：排名、代號、名稱、評分、觸發數、條件標籤、操作建議、報酬比、訊號明細", sz=14, color=GRAY, align=PP_ALIGN.CENTER)
txt(s, 1.1, 5.7, 11.2, 0.4, "候選池：成交量前 500 名  |  ≥2 有效因子才評分  |  FinMind 402 自動切 TWSE 備援", sz=15, color=DIM, align=PP_ALIGN.CENTER)
...
txt(s, 0.8, 5.5, 11.4, 0.5, "💡 系統每日 16:30 自動更新（~5 分鐘）  |  FinMind 額度耗盡自動切 TWSE 備援", sz=16, color=DIM, align=PP_ALIGN.CENTER)
...
bar(s, 4.5, 3.3, 4)
txt(s, 1, 3.6, 11, 0.8, "台股智慧選股系統 v3.6", sz=24, color=WHITE, align=PP_ALIGN.CENTER)
txt(s, 1, 4.8, 11, 0.5, "多因子篩選  ×  AI 智慧分析  ×  動能信號偵測", sz=18, color=DIM, align=PP_ALIGN.CENTER)
